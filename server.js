...
const app = express();
const PORT = 3000;
const dbPath = './companies.db';
const pythonScriptPath = './Python/main.py'; // Relative path to your Python script
...
app.post('/api/investment', (req, res) => {
    ...
    exec(`py ./Python/investment_return_calculator.py "${inputData.replace(/"/g, '\\"')}"`, (error, stdout, stderr) => {
